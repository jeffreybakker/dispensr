def init():
    ...
    prescriptions = [
        ...
        Prescription(4, 4, 5, "Dik opsmeren", 20, 0, 80, 0, 0, 8, calendar.timegm(time.gmtime()), 949174800),
        Prescription(5, 4, 6, "Dun opsmeren", 400, 7200, 3, 0, 0, 8, calendar.timegm(time.gmtime()), 1176683430),
        Prescription(6, 6, 7, "Aanmengen met water en opdrinken, vervolgens wegspoelen met water", 5, 1800, 10, 0, 0, 2,
    ...
    drugs = [
        ...
        Inventory(4, "Kinzalkomb", "pil", 500, 5),
